...
export default function Admin() {
    ...
    // =====================================================
    // LOAD SUBSCRIPTIONS WHEN ADMIN PAGE OPENS
    // =====================================================
        ...
        ========================================== */}
                ...
                <div className="card border-0 shadow-sm rounded-4">
                    ...
                    <div className="card-body p-0">
                        ...
                        <div
                            className="d-flex overflow-auto border-bottom"
                        >

                            <button
                                type="button"
                                className={`btn rounded-0 px-4 py-3 ${tab === "dashboard"
                            ...
                            <button
                                type="button"
                                className={`btn rounded-0 px-4 py-3 ${tab === "orders"
                                        ? "text-success fw-bold border-bottom border-success border-3"
                                        : "text-muted"
                                    }`}
                                onClick={() =>
                            ...
                            <button
                                type="button"
                                className={`btn rounded-0 px-4 py-3 ${tab === "customers"
                                        ? "text-success fw-bold border-bottom border-success border-3"
                                        : "text-muted"
                                    }`}
                                onClick={() =>
                            ...
                            <button
                                type="button"
                                className={`btn rounded-0 px-4 py-3 ${tab === "subscriptions"
                                        ? "text-success fw-bold border-bottom border-success border-3"
                                        : "text-muted"
                                    }`}
                                onClick={() =>
                            ...
                            <div className="p-4">
                                ...
                                <div className="row g-4">
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <span
                                                                                className={`badge rounded-pill ${order.status ===
                                                                                        "Delivered"
                                                                                        ? "text-bg-success"
                                                                                        : order.status ===
                                                                                            "Out for Delivery"
                                    ...
                                    <div className="col-lg-4">
                                        ...
                                        <div
                                            className="p-4 rounded-4 bg-success text-white h-100"
                                        >
                                                ...
                                                (user) => (
                                                    ...
                                                    >
                                                        ...
                                                        <td>
                                                            ...
                                                            <span
                                                                className={`badge rounded-pill ${user.role ===
                                                                        "admin"
                                                                        ? "text-bg-dark"
                                                                        : "text-bg-light"
                                                                    }`}
                                            ...
                                            <tbody>
                                                ...
                                                {subscriptions.map(
                                                    (subscription) => {
                                                        ...
                                                        /*
                                                         * Find customer information from
                                                         * AppContext users using user_id.
                                                         *
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span
                                                                        className={`badge rounded-pill ${subscription.status ===
                                                                                "Active"
                                                                                ? "text-bg-success"
                                                                                : subscription.status ===
                                                                                    "Paused"
